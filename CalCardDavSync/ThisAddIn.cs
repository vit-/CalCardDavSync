...
namespace CalCardDavSync
{
    public partial class ThisAddIn
    {
        ...
        private void IterateContactsItems(IFolder folder, Outlook.Folder olFolder, string tmpFilename)
        {
        ...
        private void SyncContacts()
        {
            ...
            {
                IterateContactsItems(session.OpenFolder(urlContacts), olFolderContacts, tmpFilnameContacts);
        ...
        private void SyncCalendar()
        {
            ...
            {
                IterateCalendarItems(session.OpenFolder(urlCalendar), olFolderCalendar, tmpFilnameCalendar);
                Thread.Sleep(threadSleepTime);
            }
        }
